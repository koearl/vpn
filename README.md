...
| 项目名称      | 创建时间   | 支持协议                                               | 速度评分 | 推荐评分 | 对比                                                         |
| :------------ | :--------- | :----------------------------------------------------- | :------- | :------- | :----------------------------------------------------------- |
| Shadowsocks   | 2015年前   | sock5                                                  | 6        | 2        |                                                              |
| Shadowsocks-R | 2016年前后 | sock5+混淆协议                                         | 5        | 1        |                                                              |
| V2Ray         | 2019下半年 | Blackhole Freedom HTTP MTProto Shadowsocks Socks VMess | 1        | 4        | V2ray比较成熟，支持的配套客户端是最多的，隐秘性良好          |
